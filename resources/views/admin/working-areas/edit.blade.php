...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-md-flex justify-content-between align-items-center mb-20">
                        <h6 class="card-title mb-0">Update Working Area</h6>
                        <div>
                        </div>
                    </div>
                    @include('flash::message')

                    <form action="{{ route('working-areas.update', ['working_area' => $workingArea->id]) }}" method="post"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title"
                                        ...
                                        value="{{ empty($workingArea) ? '' : old('title', $workingArea->title) }}">
                                    @error('title')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description"
                                        ...
                                        rows="3">{{ empty($workingArea) ? '' : old('description', $workingArea->description) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order" class="form-control" id="order"
                                        value="{{ empty($workingArea) ? '' : old('order', $workingArea->order) }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <a href="#" data-toggle="modal" data-target="#deleteModal_{{ $workingArea->id }}"
    ...
    <!-- Modal -->
    <div class="modal fade" id="deleteModal_{{ $workingArea->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('working-areas.destroy', $workingArea->id) }}" method="POST">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
