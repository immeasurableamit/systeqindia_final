...
@section('title')
Slider Services | Systeqindia Facility Management Services
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-md-flex justify-content-between align-items-center mb-20">
                        <h6 class="card-title mb-0">Update Slider Service</h6>
                        <div>
                        </div>
                    </div>
                    @include('flash::message')

                    <form action="{{ route('slider-services.update',['slider_service' => $slider->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slider_image"
                                        ...
                                        id="slider_image" value="{{ $slider->slider_image }}">
                                    @error('slider_image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <a href="#" data-toggle="modal" data-target="#deleteModal_{{$slider->id}}" class="btn btn-danger"> Delete</a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                   <form action="{{ route('slider-services.destroy', $slider->id) }}" method="POST">
    {{ method_field('DELETE') }}
    {{ csrf_field() }}
